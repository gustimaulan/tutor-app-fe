      ...
      <div class="p-4 md:p-6">
        ...
        <!-- Content -->
          ...
          <div class="block w-full">
            ...
            <!-- Table with Data -->
            <div v-else-if="filteredTutors && filteredTutors.length > 0" class="border border-gray-200 rounded-lg">
              <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200">
                  ...
                  <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <template v-if="isLoading && (!tutors || tutors.length === 0)">
                      ...
                      >
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                          <div class="relative dropdown-container">
                            <button
                              @click.stop="openDropdownMenu($event, tutor.id)"
...
const openDropdownMenu = (event, tutorId) => {
